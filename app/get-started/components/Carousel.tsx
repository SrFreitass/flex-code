            ...
            >
                {slides.map((slide, i) => (
                    <SwiperSlide key={i} className={`flex items-center justify-center`}>
                        <div className="absolute top-0 left-0 w-full bg-black bg-opacity-50 rounded-xl" />
                        ...
                        <Image src={slide} alt="" width={759} height={878} className="h-full rounded-xl object-cover" />
                    </SwiperSlide>
                ))}
            </Swiper>
        </div>
