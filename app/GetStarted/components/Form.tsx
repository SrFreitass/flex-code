    ...
    return(
        <form className="flex flex-col gap-14 w-1/2 max-lg:w-full">
            ...
            <div className="flex flex-col items-start gap-6 w-full">
                <Input className="focus:outline-blue-500" label="Your name" required />
                <Input className="focus:outline-blue-500" label="Your work email" type="email" required/>
                <Textarea className="focus:outline-blue-500" label="How can we help?" required/>
