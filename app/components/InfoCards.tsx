    ...
    <div className="flex flex-col gap-8 mt-24 max-lg:hidden">
      <div className="flex justify-between">
        <div className="bg-info-card p-6 rounded-[20px] w-64">
          <h2 className="text-[5.25rem] font-degular">230+</h2>
        ...
        <Image src="/info-card-img.png" alt="" width={300} height={300} unoptimized/>
      </div>

        <div className="bg-info-card p-8 rounded-[20px] w-[36rem]">
